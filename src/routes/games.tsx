...
export const Route = createFileRoute("/games")({
  head: () => ({ meta: [{ title: "Games — Vibe Malayali" }] }),
  component: Games,
});
  ...
  return (
    <div className="relative min-h-screen grid-bg lg:pl-[72px]">
      ...
      <div className="mx-auto max-w-md px-4 pt-8 pb-32">
        ...
        <h1 className="font-mal text-3xl font-extrabold mt-1"><span className="text-gradient">കളിക്കാം</span> together 🎮</h1>
        ...
        <div className="mt-5 rounded-3xl glass-strong p-5 shadow-neon overflow-hidden relative">
          ...
          <p className="text-[10px] uppercase tracking-widest text-amber-400 font-bold">🏆 Weekly Challenge</p>
        ...
        <div className="mt-6 grid grid-cols-2 gap-3">
          {GAMES.map((g) => (
            <button key={g.name} className="group relative aspect-[4/5] overflow-hidden rounded-3xl glass shadow-glow transition-transform active:scale-95 hover:-translate-y-1">
